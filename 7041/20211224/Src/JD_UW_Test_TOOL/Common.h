...
#define CONV_RETURNCODE			_T("\\RETURNCODE\\")
#define CONV_CHANNEL_STATUS		_T("\\CHANNEL_STATUS\\")
#define CONV_CHANNEL_PAPER		_T("\\CHANNEL_PAPER\\")
...
public:
	...
	**/
	static CString ConvUTF8toShiftJIS( const CString& InUTF8);
	...
	/**
		...
		* @retval Shift-JISの文字列
	**/
	static CString ConvShiftJIStoUTF8( const CString& InShiftJIS);
