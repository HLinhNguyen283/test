...
CString GetJmfResponseData(UINT nJmfType)
{
	...
	// ReturnCode
	if ( JmfData.Find( CONV_RETURNCODE ) != -1 ) JmfData.Replace(CONV_RETURNCODE, CGetIniFileParam::GetReturnCode());
	// チャネルID
	if ( JmfData.Find( CONV_CHANNEL_STATUS ) != -1 ) JmfData.Replace(CONV_CHANNEL_STATUS, CGetIniFileParam::GetChannelStatus());
	if ( JmfData.Find( CONV_CHANNEL_PAPER ) != -1 ) JmfData.Replace(CONV_CHANNEL_PAPER, CGetIniFileParam::GetChannelPaper());
...
_T("<XJMF xmlns=\"http://www.CIP4.org/JDFSchema_2_0\">\r\n\
	...
	<ResponseStatus ReturnCode=\"\\RETURNCODE\\\">\r\n\
		<Header DeviceID=\"UW0001\" ID=\"l_000002\" Time=\"20\" refID=\"\\CHANNEL_STATUS\\\" />\r\n\
	</ResponseStatus>\r\n\
</XJMF>\r\n");
...
_T("<XJMF xmlns=\"http://www.CIP4.org/JDFSchema_2_0\">\r\n\
	...
	<ResponseStatus ReturnCode=\"\\RETURNCODE\\\">\r\n\
		<Header DeviceID=\"UW0001\" ID=\"l_000002\" Time=\"\\TIME\\\" refID=\"\\CHANNEL_PAPER\\\" />\r\n\
	</ResponseStatus>\r\n\
</XJMF>\r\n");
...
_T("<XJMF xmlns=\"http://www.CIP4.org/JDFSchema_2_0\">\r\n\
	...
	<Response ReturnCode=\"\\RETURNCODE\\\">\r\n\
		...
		<SubscriptionInfo DeviceID=\"UW0001\" MessageType=\"Media\" ChannelID=\"Channel\">\r\n\
