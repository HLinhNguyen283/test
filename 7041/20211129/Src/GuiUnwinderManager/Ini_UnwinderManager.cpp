...
std::string Ini_UnwinderManager::getQueryStatus_CannelID()
{
	char cBuf[256];
...
std::string Ini_UnwinderManager::getQueryResource_CannelID()
{
	char cBuf[256];
...
BOOL Ini_UnwinderManager::putStatusCannelID( const std::string& InCannelID )
{
	return WriteValueString("CHANNEL", "Status_CannelID", InCannelID.c_str());
}

BOOL Ini_UnwinderManager::putResourceCannelID( const std::string& InCannelID )
{
