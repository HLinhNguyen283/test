...
public:
	...
	**/
	CXmlParse(UwRwXjmfDataMap& inUwXjmfDataMap);
...
protected:
	...
	UwRwXjmfDataMap&				m_UwXjmfDataMap;		// XMLのデータMAP
...
public:
	...
	**/
	CXmlParseFile(const std::string& inXmlFilePath, UwRwXjmfDataMap& inUwXjmfDataMap);
...
public:
	/**
		...
		* @param  outUwXjmfDataMap : [o]XMLデータから取り出した情報
	**/
	CXmlParseData(const std::string& inXmlData, UwRwXjmfDataMap& inUwXjmfDataMap);
