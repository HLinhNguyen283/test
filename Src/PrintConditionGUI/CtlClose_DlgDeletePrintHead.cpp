/*! \file CtlClose_DlgDeletePrintHead.cpp
...
/*! \brief constructor
*/
CCtlClose_DlgDeletePrintHead::CCtlClose_DlgDeletePrintHead()
{
...
*/
void CCtlClose_DlgDeletePrintHead::OnSetAttribute()
{
...
*/
long CCtlClose_DlgDeletePrintHead::OnCommand(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case BN_CLICKED:
		{
			...
			if(ctlWnd == m_ctl[CTRLID_BN_CLOSE]){
				// Notify close dialog
				if(pData->ExitDeletePrintHeadAlignmentDlg()){
