...
/*! \brief constructor
*/
CCtlClose_DlgDeletePaperType::CCtlClose_DlgDeletePaperType()
{
...
*/
void CCtlClose_DlgDeletePaperType::OnSetAttribute()
{
...
*/
long CCtlClose_DlgDeletePaperType::OnCommand(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case BN_CLICKED:
		{
			...
			if(ctlWnd == m_ctl[CTRLID_BN_CLOSE]){
				// Notify close dialog
				if(pData->ExitDeletePaperTypeDlg()){
